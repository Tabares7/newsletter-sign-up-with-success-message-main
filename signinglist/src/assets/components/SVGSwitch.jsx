...
const SVGSwitch = () => {
 ...
 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="400"
    ...
    <defs>
        ...
        <linearGradient id="k" x1="50%" x2="50%" y1="0%" y2="100%">
            <stop offset="0%" stopColor="#FFB443" />
            <stop offset="100%" stopColor="#FF5B64" stop-opacity="0" />
        </linearGradient>
        <linearGradient id="o" x1="50%" x2="50%" y1="0%" y2="100%">
            <stop offset="0%" stopColor="#F8F8F8" />
            <stop offset="100%" stopColor="#EEE" />
    ...
    <g fill="none" fillRule="evenodd">
        ...
        <g mask="url(#c)">
            ...
            <g transform="translate(-176 226)">
                ...
                <circle cx="136.446" cy="-34.554" r="158" fill="url(#k)" fillRule="nonzero"
            ...
            <g transform="translate(246 93)">
                ...
                <path fill="url(#r)" fillRule="nonzero"
                ...
                <path fill="#242742" fillRule="nonzero"
